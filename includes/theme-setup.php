...
function theme_load_assets()
{
    ...
    wp_enqueue_style('swiper_css', get_theme_file_uri('/assets/css/swiper-bundle.min.css'), [], '20.0');
    wp_enqueue_style('thememaincss', get_theme_file_uri('/build/index.css'), [], '20.0');
