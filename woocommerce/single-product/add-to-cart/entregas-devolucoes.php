<?php
$entregas_e_devolucoes_b2b = get_field("entregas_e_devolucoes_b2b", "option");
$entregas_e_devolucoes_b2c = get_field("entregas_e_devolucoes_b2c", "option");
$apoio_ao_cliente = get_field("apoio_ao_cliente", "option");

?>

<?php if ($entregas_e_devolucoes_b2c || $apoio_ao_cliente || $entregas_e_devolucoes_b2b) { ?>
  <div class="">
    <?php if ($args['is_b2b']) { ?>
      <?php if ($entregas_e_devolucoes_b2b) { ?>
